...
def graphdata():
    ...
    try:
        name = graph_data(plotdatax, plotdatay, hasxerror, xerror, hasyerror, yerror, title, xlabel, ylabel, fontsize, grid, usetex, legend, linestyle, linecolor, linewidth, marker, markercolor, linefit, fitcolor)
        return bottle.template("templates/graph_data.tpl", errormessage="", hasxerror=hasxerror, hasyerror=hasyerror, xerror=xerror, yerror=yerror, plotdatay=plotdatay, plotdatax=plotdatax, name=name, title=title, xlabel=xlabel, ylabel=ylabel, fontsize=fontsize, grid=grid, usetex=usetex, legend=legend, linestyle=linestyle, linewidth=linewidth, linecolor=linecolor, marker=marker, markercolor=markercolor, linefit=linefit, fitcolor=fitcolor)
    except Exception:
        errormessage="Vnešeni podatki niso ustrezni."

...
<body>
    ...
    <div class="container-fluid">
        ...
        <div>
            <div class="buttons">
                <button class="btn4" id="add-row">dodaj vrstico</button>
                <button class="btn5" id="clear">izprazni tabelo</button>
            </div>
        </div>
                ...
                <div class="container">
                    <div class="row align-items-start">
                        <div class="row-sm row-md col-lg-7 col-xl-7 col-xxl-7">
                            ...
                            <div class="row mb-3">
                                <label for="title"
                                    class="row-sm col-md-3 col-lg-3 col-xl-3 col-xxl-3 col-form-label">naslov
                                    grafa </label>
                            ...
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-4 col-md-3 col-lg-2 col-xl-2 col-xxl-2">
                                    <input type="number" class="form-control" id="linewidth" name="linewidthInput"
                                        min="1" max="8" value="2" oninput="this.form.linewidthRange.value=this.value" />
                                </div>
                            ...
                            <div class="row mb-3 align-items-center">
                                <label for="fontsize"
                                    ...
                                    črk</label>
                                <div class="col-4 col-md-3 col-lg-2 col-xl-2 col-xxl-2">
                                    <input type="number" class="form-control" id="fontsize" name="fontsizeInput"
                                        min="10" max="40" value="25"
                                        oninput="this.form.fontsizeRange.value=this.value" />
                                </div>
